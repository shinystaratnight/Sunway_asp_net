namespace Web.Template.API.Content
{
    ...
    public class SiteBuilderController : ApiController
    {
        ...
        /// </summary>
        private ISiteBuilderService siteBuilderService;
        ...
        public string GetModel(string site, string entityName, string context, string mode)
        {
            ...
            if (contentDetailsReturn?.Content == null && mode == "draft")
            {
        ...
        /// <summary>
        /// Adds a context bridge
        /// </summary>
        /// <param name="contextBridge">The context bridge model.</param>
        /// <param name="site">The site.</param>
        /// <param name="entityName">Name of the entity.</param>
        /// <param name="context">The context.</param>
        /// <returns>
        /// The response from the sitebuilder
        /// </returns>
        [Route("api/sitebuilder/contextBridge/{site}/{entityName}/{context}/add")]
        [HttpPut]
        public string AddContextBridge([FromBody] ContextBridgeRequest contextBridge, string site, string entityName, string context)
        {
            contextBridge.Entity = entityName;
            return this.siteBuilderService.ModifyContextBridge(contextBridge, site);
        }
