...
class Page {
    constructor(customerContainers, customerWidgets, customerComponents) {
        if (!pageInstance) {
            pageInstance = this;
        }

        this.customerContainers = customerContainers;
        this.customerWidgets = customerWidgets;
    ...
    renderWidget(widget, siteName) {
        ...
        const widgetContainerProps = {
            ...
            customerWidgets: this.customerWidgets,
            customerComponents: this.customerComponents,
        };
    ...
    renderWidgets() {
        ...
        const tradeLogin = state.session.UserSession.TradeSession
                            && state.session.UserSession.TradeSession.LoggedIn;
        ...
        state.page.Widgets.forEach(widget => {
            if ((widget.ClientSideRender
                ...
                && (widget.AccessDisplay !== 'TradeLoggedIn' || tradeLogin))
