...
export default class SliderInput extends React.Component {
    ...
    getMinPriceInputProps() {
        const priceInputProps = {
            ...
            error: this.state.minTextBox.showWarning
                ...
                : '',
            prependText: this.props.currencySymbol,
            containerClasses: 'min-price-input col-xs-6 col-sm-3 col-md-2',
        };
    ...
    getMaxPriceInputProps() {
        const priceInputProps = {
            ...
            error: this.state.maxTextBox.showWarning
                ...
                : '',
            prependText: this.props.currencySymbol,
            containerClasses: 'max-price-input col-xs-6 col-sm-3'
    ...
    handleMouseMove(event) {
        if (this.state.isSliding) {
            ...
            const posX = eventX - this.state.input.left;
    ...
    render() {
        ...
        let containerClasses = 'slider-input-container';
        let sliderClasses = 'slider-input';

        if (this.props.showMaxPriceInput && this.props.showMinPriceInput) {
            containerClasses = `${containerClasses} row text-inputs-visible`;
            sliderClasses
                ...
                <div id={sliderId} className={sliderClasses}>
                    ...
                    {this.props.showPriceRange
                        && <p className="slider-range-display">
                            {this.state.minControl.value} - {this.state.maxControl.value}
                        </p>}
                </div>
            </div>
        );
