...
export default class CarouselContentContainer extends React.Component {
    ...
    setupCarouselContentProps() {
        ...
        const carouselContentProps = {
            ...
            carouselTiles: parseInt(configuration.CarouselTiles, 10),
    ...
    render() {
        ...
        const itemType = contentModel.CarouselItemType.toLowerCase();
        const containerAttributes = {
            className: `widget carousel-content ${itemType}`,
        };

        const backgroundDiv = {
            className: 'img-background',
            style: {
                backgroundImage: `url('${contentModel.BackgroundImage}')`,
            },
        };
        ...
        return (
            <div {...containerAttributes}>
                {contentModel.BackgroundImage && contentModel.BackgroundImage !== ''
