import 'widgets/bookingjourney/_searchTool.scss';
...
export default class SearchTool extends React.Component {
    ...
    renderTabs() {
        const tabContainerClass = this.props.startCollapsed ? '' : 'container';
        return (
    ...
    renderSearchForm() {
        ...
        const searchFormContentClass = this.props.startCollapsed
