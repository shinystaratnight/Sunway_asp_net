...
class WidgetEdit extends React.Component {
    ...
    render() {
        ...
        const entityAutoComplete = {
            name: 'entityAuto',
            lookup: `context|${this.props.entityName}`,
            onChange: (name, value) => {
                this.props.onCopyChange(value);
            },
            placeholder: 'Entity to copy from',
            value: '',
            siteName: this.props.siteName,
            error: this.props.copyError,
            containerClass: 'entity-auto-input',
        };
                ...
                <header className="header">
                    ...
                    {this.props.displayCopy
                        && <button type="button"
                            ...
                            <span className="fa fa-floppy-o"></span>Save Copy</button>}

                    {this.props.displayCopy
                        && <button type="button"
                                className="btn btn-default btn-copy"
                                onClick={this.props.onCopyCancel}>
                            <span className="fa fa-times"></span>Cancel Copy</button>}

                    {!this.props.displayCopy
                       && <button type="button"
                                 className="btn btn-default btn-copy"
                                 onClick={this.props.onCopyDisplay}>
                               <span className="fa fa-clone"></span>Copy</button>}

                    {this.props.displayCopy
                        && <AutoCompleteInput {...entityAutoComplete}/>}
...
WidgetEdit.propTypes = {
    ...
    displayCopy: React.PropTypes.bool,
    ...
    onCopyCancel: React.PropTypes.func.isRequired,
    onCopyDisplay: React.PropTypes.func.isRequired,
    onCopyChange: React.PropTypes.func.isRequired,
