namespace Web.Template.IoC
{
    ...
    public class AutofacModule : Module
    {
        ...
        private void RegisterConfigurationClasses(ContainerBuilder builder)
        {
            ...
            builder.RegisterType<Mapper>().SingleInstance().As<IMapper>();

            builder.Register(c => new MapperConfiguration(cfg => { cfg.AddProfile<AutoMapperConfig>(); })).AsSelf().SingleInstance();
        ...
        private void RegisterServices(ContainerBuilder builder)
        {
            ...
            builder.RegisterType<IpLookupService>().As<IIpLookupService>();
