namespace Web.TradeMMB.API.Content
{
    ...
    public class SiteBuilderController : ApiController
    {
            ...
            var viewModel = new SessionViewModel()
                                {
                                    ...
                                    Success = session.UserSession.LoggedIn
                                };
        ...
        [Route("api/sitebuilder/images/{site}/{search?}")]
        [HttpGet]
        ...
        {
            ContentDetailsReturn contentDetailsReturn = this.siteBuilderService.GetModel(
                site, 
                entityName, 
                context, 
                mode);
