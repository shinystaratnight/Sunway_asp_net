namespace Web.TradeMMB.IoC
{
    ...
    public class AutofacModule : Module
    {
        ...
        {
            builder.RegisterType<Site>().As<ISite>();
        ...
        private void RegisterServices(ContainerBuilder builder)
        {
            ...
            builder.RegisterType<Web.Template.Application.Services.BookingService>().As<Template.Application.Interfaces.Services.IBookingService>();
