namespace Web.TradeMMB.IoC
{
    ...
    public class AutofacRoot
    {
        ...
        public static void Setup()
        {
            ...
            builder.RegisterModule(new Web.Template.Data.IoC.AutofacModule());
            builder.RegisterModule(new Web.Template.Application.IoC.AutofacModule());
        ...
        public static void SetupForTests()
        {
            ...
            Mapper.Initialize(c => c.ConstructServicesUsing(t => container.Resolve(t)));
        }
    }
}