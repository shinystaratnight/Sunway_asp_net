 ...
 * @param {string} key - The entity type
 * @return {object} The action type
 */
 ...
 * @param {string} key - The entity type
 * @param {object} models - The models for that entity type
 ...
 */
export function loadEntityContexts(site, entity) {
    return function load(dispatch) {
        dispatch(entityLoadContextsRequest(entity));
        const entityAPI = new EntityAPI();
        return entityAPI.loadContextsList(site, entity)
            .then(contexts => {
