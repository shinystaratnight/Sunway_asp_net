class NumberFunctions {
    /**
     * Function to add a group seperator to a given number
     * @param {number} number - The number to update
     * @return {string} the number with the group seperator added.
    */
    static addGroupSeperator(number) {
    ...
    */
    static formatPrice(amount, pricingConfiguration, currency) {
        ...
        price = pricingConfiguration.ShowGroupSeperator
            ? NumberFunctions.addGroupSeperator(price)
            : price;
