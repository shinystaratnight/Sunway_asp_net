...
export function loadUser() {
    const userUrl = '/booking/api/user';
    const options = {
...
export function userLogOut() {
    const logOutUrl = '/booking/api/user/logout';
    const options = {
        credentials: 'same-origin',
    };
    return function load(dispatch) {
...
export function userLogOutAdmin() {
    const logOutUrl = '/booking/api/user/logoutadmin';
    const options = {
        credentials: 'same-origin',
    };
    return function load(dispatch) {
...
export function userChangeSite(website) {
    const changeUserUrl = `/booking/api/user/website/${website}`;
    const options = {
        credentials: 'same-origin',
    };
...
export function adminLogin(username, password) {
    let loginUrl = '/booking/api/sitebuilder/login?';
