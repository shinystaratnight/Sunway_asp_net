...
class WidgetContainer extends React.Component {
    ...
    render() {
        let Container = {};
        if (window.importedContainers
            && window.importedContainers.hasOwnProperty(`${this.props.entityName}Container`)) {
            Container = window.importedContainers[`${this.props.entityName}Container`];
        } else if (this.props.customerContainers
