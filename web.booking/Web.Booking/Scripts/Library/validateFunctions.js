class ValidateFunctions {
    ...
    */
    static isNumericPhoneNumberKey(sAlpha) {
    ...
    static isNumericPhoneNumber(sAlpha) {
        ...
        const regexPass = o.test(sAlpha);
        return regexPass && sAlpha !== '' && sAlpha.length > minStringLength;
    }
    ...
    */
     ...
     * @return {boolean} true if isEditKey or isNUmericKey functions return true.
    */
    static isColonKey(whichCode) {
        const code = parseInt(whichCode, 10);
        let isColonKey = false;
        const shiftKey = 16;
        const colonKey = 186;
        if ((code === shiftKey) || (code === colonKey)) {
            isColonKey = true;
        }
        return isColonKey;
    }
