namespace Web.Booking.API.BookingJourney
{
    ...
    public class UserController : ApiController
    {
        ...
        [HttpGet]
        public async Task<SessionViewModel> TradeLogin([FromUri] string username = "", [FromUri] string password = "", [FromUri] string websitePassword = "", [FromUri] string emailAddress = "")
        {
